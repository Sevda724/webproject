    ...
    <form id="frm-logout" action="{{ route('logout') }}" method="POST" style="display: none;">
        ...
        <div id="content" class="site-content">
            <div id="primary" class="content-area column full">
                ...
                <h2>{{ __('lang.masterandmargotitle')}} #0321</h2>
                <h3>{{ __('lang.masterandmargoauthor')}}</h3>
                <h4>{{ __('lang.masterandmargodes')}}</h4>
                <h3 style="margin-top: 50px; margin-bottom: 30px">{{ __('lang.amount')}}: 1800 {{ __('lang.tg')}}</h3>
